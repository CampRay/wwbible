...
namespace Nop.Admin.Controllers
{
    public partial class ProductController : BaseAdminController
    {
        ...
        public ActionResult ProductList(DataSourceRequest command, ProductListModel model)
        {
            ...
            var productTemplateList = _productTemplateService.GetAllProductTemplates();
            ...
            gridModel.Data = products.Select(x =>
            {
                ...
                var productTemplate = productTemplateList.Where(pt => pt.Id == x.ProductTemplateId).FirstOrDefault();
        ...
        public ActionResult ExportExcelAll(ProductListModel model)
        {
            ...
            try
            {
                ...
                return File(bytes, MimeTypes.TextXlsx, "WebPages.xlsx");
            }
            catch (Exception exc)
            {
                ErrorNotification(exc);
