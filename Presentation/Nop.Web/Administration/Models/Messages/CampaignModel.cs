...
namespace Nop.Admin.Models.Messages
{
    ...
    public partial class CampaignModel : BaseNopEntityModel
    {
        public CampaignModel()
        {
            ...
            this.EmailType = new List<SelectListItem>();
        }
        ...
        [NopResourceDisplayName("Admin.Promotions.Campaigns.Fields.EmailType")]
        public int EmailTypeId { get; set; }
        public IList<SelectListItem> EmailType { get; set; }

        [NopResourceDisplayName("Admin.Promotions.Campaigns.Fields.LectureId")]
