...
namespace Nop.Web.Controllers
{
    public partial class NewsletterController : BasePublicController
    {
        ...
        [HttpPost]
        [PublicAntiForgery]        
        public ActionResult NewsLetterSubscription(NewsLetterSubscriptionModel model)
        {
            ...
            try
            {
                _workflowMessageService.SendDonateFeedbackMessage(subscription, _workContext.WorkingLanguage.Id);
            }
            catch { }
            model.Successfully = true;
            model.Result = _localizationService.GetResource("Donate.Successfully");
            return View(model);
        }
