...
namespace Nop.Web.Infrastructure.Cache
{
        ...
        IConsumer<EntityUpdated<ShoppingCartItem>>
    {
        ...
        /// <summary>
        /// Key for BookNavigationModel caching
        /// </summary>
        /// <remarks>
        /// {0} : language id
        /// {1} : current store ID
        ...
        /// </remarks>
        public const string BOOK_NAVIGATION_MODEL_KEY = "Nop.pres.book.navigation-{0}-{1}-{2}";
        public const string BOOK_NAVIGATION_PATTERN_KEY = "Nop.pres.book.navigation";

        /// <summary>
        /// Key for BookCategoryModel caching
        /// </summary>
        /// <remarks>
        /// {0} : language id
        /// {1} : current store ID
        /// {2} : current category ID
        /// </remarks>
        public const string BOOK_CATEGORY_MODEL_KEY = "Nop.pres.book.category-{0}-{1}-{2}";
        public const string BOOK_CATEGORY_PATTERN_KEY = "Nop.pres.book.category";
        ...
        public void HandleEvent(EntityInserted<Language> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(BOOK_NAVIGATION_PATTERN_KEY);
            _cacheManager.RemoveByPattern(BOOK_CATEGORY_PATTERN_KEY);
