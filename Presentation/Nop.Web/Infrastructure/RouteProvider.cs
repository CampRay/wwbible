...
namespace Nop.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapLocalizedRoute("BookSearch",
                            "searchbook/{searchTerms}/{categoryId}",
                            new { controller = "Catalog", action = "SearchBook", categoryId = UrlParameter.Optional },
                            new { categoryId = @"\d+" },
                            new[] { "Nop.Web.Controllers" });
            ...
            //Daily Category
            routes.MapLocalizedRoute("DailyCategory",
                            "producttag/{categoryId}/{groupName}",
                            new { controller = "Catalog", action = "DailyProduct", groupName = UrlParameter.Optional },
                            new { categoryId = @"\d+" },
                            new[] { "Nop.Web.Controllers" });

            //daily product
            routes.MapLocalizedRoute("DailyProduct",
                            "productdaily/{categoryId}",
                            new { controller = "Product", action = "DailyProduct"},
                            new { categoryId = @"\d+" },
                            new[] { "Nop.Web.Controllers" });
            ...
            //Category downloads
            routes.MapRoute("GetFileDownload",
                            "download/category/{downloadId}",
                            new { controller = "Download", action = "GetFileDownload" },
                            new { downloadId = @"\d+" },
                            new[] { "Nop.Web.Controllers" });
            ...
            //Apply Lecture
            routes.MapLocalizedRoute("ApplyLecture",
                            "applylecture",
                            new { controller = "Affiliate", action = "Create" },
                            new[] { "Nop.Web.Controllers" });
            ...
            //activate Affiliate
            routes.MapLocalizedRoute("AffiliateActivation",
                            "affiliate/activation/{token}",
                            new { controller = "Affiliate", action = "Activation" },
                            new { token = new GuidConstraint(false) },
                            new[] { "Nop.Web.Controllers" });
