...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Category : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to show the category on YinJin Menu
        /// </summary>
        public bool IsYinJinMenu { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether to show the category on HongDao Menu
        /// </summary>
