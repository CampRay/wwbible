...
namespace Nop.Services.Messages
{
    public partial interface IWorkflowMessageService
    {
        ...
        /// <summary>
        /// Sends a newsletter subscription feedback message
        /// </summary>
        /// <param name="subscription">Newsletter subscription</param>
        /// <param name="languageId">Language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendDonateFeedbackMessage(NewsLetterSubscription subscription,int languageId);

        #endregion

        #region Affiliate Lecture
        ...
        /// <param name="languageId">Language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendApplyLectureActivationMessage(Affiliate affiliate,int languageId);       
